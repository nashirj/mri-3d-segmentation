"""Unet2D model implementation.
Adapted from https://github.com/ELEKTRONN/elektronn3/blob/98956384a1af14af086647b8fbae52016597d320/elektronn3/models/unet.py
"""
...
if __name__ == "__main__":
    ...
    # [B, C, H, W]
    summary = summary(model=unet, input_size=(1, 4, 240, 240), device="cpu")
