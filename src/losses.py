...
def compute_per_channel_dice(pred, target, epsilon=1e-6, weight=None):
    """
    ...
    # here we can use standard dice (pred + target).sum(-1) or extension (see V-Net) (pred^2 + target^2).sum(-1)
